...
impl From<PIN10_A> for bool {
    ...
    fn from(variant: PIN10_A) -> Self {
        match variant {
            PIN10_A::NOTLATCHED => false,
            PIN10_A::LATCHED => true,
        }
    }
}
...
impl From<PIN11_A> for bool {
    ...
    fn from(variant: PIN11_A) -> Self {
        match variant {
            PIN11_A::NOTLATCHED => false,
            PIN11_A::LATCHED => true,
        }
    }
}
...
impl From<PIN12_A> for bool {
    ...
    fn from(variant: PIN12_A) -> Self {
        match variant {
            PIN12_A::NOTLATCHED => false,
            PIN12_A::LATCHED => true,
        }
    }
}
...
impl From<PIN13_A> for bool {
    ...
    fn from(variant: PIN13_A) -> Self {
        match variant {
            PIN13_A::NOTLATCHED => false,
            PIN13_A::LATCHED => true,
        }
    }
}
...
impl From<PIN14_A> for bool {
    ...
    fn from(variant: PIN14_A) -> Self {
        match variant {
            PIN14_A::NOTLATCHED => false,
            PIN14_A::LATCHED => true,
        }
    }
}
...
impl From<PIN15_A> for bool {
    ...
    fn from(variant: PIN15_A) -> Self {
        match variant {
            PIN15_A::NOTLATCHED => false,
            PIN15_A::LATCHED => true,
        }
    }
}
...
impl From<PIN16_A> for bool {
    ...
    fn from(variant: PIN16_A) -> Self {
        match variant {
            PIN16_A::NOTLATCHED => false,
            PIN16_A::LATCHED => true,
        }
    }
}
...
impl From<PIN17_A> for bool {
    ...
    fn from(variant: PIN17_A) -> Self {
        match variant {
            PIN17_A::NOTLATCHED => false,
            PIN17_A::LATCHED => true,
        }
    }
}
...
impl From<PIN18_A> for bool {
    ...
    fn from(variant: PIN18_A) -> Self {
        match variant {
            PIN18_A::NOTLATCHED => false,
            PIN18_A::LATCHED => true,
        }
    }
}
...
impl From<PIN19_A> for bool {
    ...
    fn from(variant: PIN19_A) -> Self {
        match variant {
            PIN19_A::NOTLATCHED => false,
            PIN19_A::LATCHED => true,
        }
    }
}
...
impl From<PIN20_A> for bool {
    ...
    fn from(variant: PIN20_A) -> Self {
        match variant {
            PIN20_A::NOTLATCHED => false,
            PIN20_A::LATCHED => true,
        }
    }
}
...
impl From<PIN21_A> for bool {
    ...
    fn from(variant: PIN21_A) -> Self {
        match variant {
            PIN21_A::NOTLATCHED => false,
            PIN21_A::LATCHED => true,
        }
    }
}
...
impl From<PIN22_A> for bool {
    ...
    fn from(variant: PIN22_A) -> Self {
        match variant {
            PIN22_A::NOTLATCHED => false,
            PIN22_A::LATCHED => true,
        }
    }
}
...
impl From<PIN23_A> for bool {
    ...
    fn from(variant: PIN23_A) -> Self {
        match variant {
            PIN23_A::NOTLATCHED => false,
            PIN23_A::LATCHED => true,
        }
    }
}
...
impl From<PIN24_A> for bool {
    ...
    fn from(variant: PIN24_A) -> Self {
        match variant {
            PIN24_A::NOTLATCHED => false,
            PIN24_A::LATCHED => true,
        }
    }
}
...
impl From<PIN25_A> for bool {
    ...
    fn from(variant: PIN25_A) -> Self {
        match variant {
            PIN25_A::NOTLATCHED => false,
            PIN25_A::LATCHED => true,
        }
    }
}
...
impl From<PIN26_A> for bool {
    ...
    fn from(variant: PIN26_A) -> Self {
        match variant {
            PIN26_A::NOTLATCHED => false,
            PIN26_A::LATCHED => true,
        }
    }
}
...
impl From<PIN27_A> for bool {
    ...
    fn from(variant: PIN27_A) -> Self {
        match variant {
            PIN27_A::NOTLATCHED => false,
            PIN27_A::LATCHED => true,
        }
    }
}
...
impl From<PIN28_A> for bool {
    ...
    fn from(variant: PIN28_A) -> Self {
        match variant {
            PIN28_A::NOTLATCHED => false,
            PIN28_A::LATCHED => true,
        }
    }
}
...
impl From<PIN29_A> for bool {
    ...
    fn from(variant: PIN29_A) -> Self {
        match variant {
            PIN29_A::NOTLATCHED => false,
            PIN29_A::LATCHED => true,
        }
    }
}
...
impl From<PIN30_A> for bool {
    ...
    fn from(variant: PIN30_A) -> Self {
        match variant {
            PIN30_A::NOTLATCHED => false,
            PIN30_A::LATCHED => true,
        }
    }
}
...
impl From<PIN31_A> for bool {
    ...
    fn from(variant: PIN31_A) -> Self {
        match variant {
            PIN31_A::NOTLATCHED => false,
            PIN31_A::LATCHED => true,
        }
    }
}
