...
#[doc = "`write(|w| ..)` method takes [amount::W](amount::W) writer structure"]
impl crate::Writable for AMOUNT {}
#[doc = "Size of outgoing frame"]
pub mod amount;
