...
impl BAUDRATER {
    ...
    pub fn bits(&self) -> u32 {
        match *self {
            ...
            BAUDRATER::BAUD14400 => 3862528,
            BAUDRATER::BAUD19200 => 5152768,
            BAUDRATER::BAUD28800 => 7716864,
            BAUDRATER::BAUD31250 => 8388608,
            BAUDRATER::BAUD38400 => 10289152,
            BAUDRATER::BAUD56000 => 15007744,
            BAUDRATER::BAUD57600 => 15400960,
            BAUDRATER::BAUD76800 => 20615168,
            BAUDRATER::BAUD115200 => 30801920,
            BAUDRATER::BAUD230400 => 61865984,
            BAUDRATER::BAUD250000 => 67108864,
            BAUDRATER::BAUD460800 => 121634816,
            BAUDRATER::BAUD921600 => 251658240,
    ...
    pub fn _from(value: u32) -> BAUDRATER {
        match value {
            ...
            3862528 => BAUDRATER::BAUD14400,
            5152768 => BAUDRATER::BAUD19200,
            7716864 => BAUDRATER::BAUD28800,
            8388608 => BAUDRATER::BAUD31250,
            10289152 => BAUDRATER::BAUD38400,
            15007744 => BAUDRATER::BAUD56000,
            15400960 => BAUDRATER::BAUD57600,
            20615168 => BAUDRATER::BAUD76800,
            30801920 => BAUDRATER::BAUD115200,
            61865984 => BAUDRATER::BAUD230400,
            67108864 => BAUDRATER::BAUD250000,
            121634816 => BAUDRATER::BAUD460800,
            251658240 => BAUDRATER::BAUD921600,
...
impl BAUDRATEW {
    ...
    pub fn _bits(&self) -> u32 {
        match *self {
            ...
            BAUDRATEW::BAUD14400 => 3862528,
            BAUDRATEW::BAUD19200 => 5152768,
            BAUDRATEW::BAUD28800 => 7716864,
            BAUDRATEW::BAUD31250 => 8388608,
            BAUDRATEW::BAUD38400 => 10289152,
            BAUDRATEW::BAUD56000 => 15007744,
            BAUDRATEW::BAUD57600 => 15400960,
            BAUDRATEW::BAUD76800 => 20615168,
            BAUDRATEW::BAUD115200 => 30801920,
            BAUDRATEW::BAUD230400 => 61865984,
            BAUDRATEW::BAUD250000 => 67108864,
            BAUDRATEW::BAUD460800 => 121634816,
            BAUDRATEW::BAUD921600 => 251658240,
