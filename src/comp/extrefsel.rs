...
impl From<EXTREFSEL_A> for u8 {
    ...
    fn from(variant: EXTREFSEL_A) -> Self {
        match variant {
            EXTREFSEL_A::ANALOGREFERENCE0 => 0,
            EXTREFSEL_A::ANALOGREFERENCE1 => 1,
            EXTREFSEL_A::ANALOGREFERENCE2 => 2,
            EXTREFSEL_A::ANALOGREFERENCE3 => 3,
            EXTREFSEL_A::ANALOGREFERENCE4 => 4,
            EXTREFSEL_A::ANALOGREFERENCE5 => 5,
            EXTREFSEL_A::ANALOGREFERENCE6 => 6,
            EXTREFSEL_A::ANALOGREFERENCE7 => 7,
        }
    }
}
