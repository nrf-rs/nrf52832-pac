...
impl CONNECTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            CONNECTR::DISABLED => false,
            CONNECTR::ENABLED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> CONNECTR {
        match value {
            false => CONNECTR::DISABLED,
            true => CONNECTR::ENABLED,
        }
    }
    #[doc = "Checks if the value of the field is `DISABLED`"]
    #[inline]
    pub fn is_disabled(&self) -> bool {
        *self == CONNECTR::DISABLED
    }
    #[doc = "Checks if the value of the field is `ENABLED`"]
    #[inline]
    pub fn is_enabled(&self) -> bool {
        *self == CONNECTR::ENABLED
    }
}
...
impl CONNECTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            CONNECTW::DISABLED => false,
            CONNECTW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _CONNECTW<'a> {
    ...
    pub fn disabled(self) -> &'a mut W {
        self.variant(CONNECTW::DISABLED)
    }
    #[doc = "Pull-up is connected to D+"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(CONNECTW::ENABLED)
    }
